...
tnpParNomFit_fa = [
    ...
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0.5,5.0]",
    "acmsP[60.,50.,80.]","betaP[0.05,0.01,0.08]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[70.,65.,75.]","betaF[0.05,0.01,0.08]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ] # bin 0
tnpParNomFit_ps1 = [
...
tnpParAltSigFit_2X_fwp = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,3]","alphaP[2.0,1.2,3.5]",'nP[3,-5,5]',"sigmaP_2[1.5,0.5,3.0]","sosP[1,0.5,5.0]",
    "meanF[-0.5,-5.0,5.0]","sigmaF[2.,0.7,3]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,3.0]","sosF[2.,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    ] # bin 21
